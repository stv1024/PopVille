...
public class NGUIDemo : MonoBehaviour {
  ...
  private const string demo0 =
      @"<p align=center><font face=title size=24><font color=yellow>HTMLEngine</font>&nbsp;for&nbsp;<font color=lime>Unity3D</font>&nbsp;and&nbsp;<font color=lime>UNGUI</font></font></p>
<br>
<p id='introduction' align=center><b>This is based on Profixy's HTMLEngine-Mini.<br>URL:&nbsp;<u>http://html-engine-mini.googlecode.com/</u><br></b></p>
...
";
  //private const string demo0 = "<p>Also this demo contains some internal resources (fonts and images) than can be used.</p>";
